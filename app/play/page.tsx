...
const PLAY_COPY = {
  en: {
    ...
    contractWarning: "Contract not deployed yet. Set NEXT_PUBLIC_SEABATTLE_V7_CONTRACT_ADDRESS in .env",
  ...
  ru: {
    ...
    contractWarning: "Контракт ещё не задеплоен. Укажи NEXT_PUBLIC_SEABATTLE_V7_CONTRACT_ADDRESS в .env",
